...
////////////////////////////////////////////////////////////// // ideo
	void setIdeologySchedule(EVMSchedule _ideoSchedule) const { ideoSchedule = _ideoSchedule; }

	EVMSchedule& getIdeologySchedule() const { return ideoSchedule; }
...
private:
	...
	mutable EVMSchedule ideoSchedule; // ideo
