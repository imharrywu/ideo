...
public:
    ...
    void SetNull()
    {
        ...
        nBits          = 0;
        nNonce         = 0;
        hashStateRoot  = uint256(); // ideo
        hashUTXORoot   = uint256(); // ideo
        vchBlockSig.clear();
    ...
    explicit CBlockIndex(const CBlockHeader& block)
    {
        ...
        nNonce         = block.nNonce;
        nMoneySupply   = 0;
        hashStateRoot  = block.hashStateRoot; // ideo
        hashUTXORoot   = block.hashUTXORoot; // ideo
        nStakeModifier = uint256();
        hashProof = uint256(); 
        prevoutStake   = block.prevoutStake; // ideo
        vchBlockSig    = block.vchBlockSig; // ideo
    }
