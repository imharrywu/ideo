...
////////////////////////////////////////////////////////////// ideo
        ...
        globalState = std::unique_ptr<IdeologyState>(new IdeologyState(dev::u256(0), IdeologyState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::ideoTestNetwork)));
