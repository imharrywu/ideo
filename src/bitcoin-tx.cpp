...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ideo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ideo-tx [options] <hex-tx> [commands]  Update hex-encoded ideo transaction\n" +
            "or:     ideo-tx [options] -create [commands]   Create hex-encoded ideo transaction\n" +
            "\n";
