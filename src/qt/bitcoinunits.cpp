...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IDEO");
    case mBTC: return QString("mIDEO");
    case uBTC: return QString::fromUtf8("μIDEO (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Ideologys");
    case mBTC: return QString("Milli-Ideologys (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Ideologys (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
